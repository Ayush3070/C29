...
var engine, world, backgroundImg, waterSound, backgroundMusic, cannonExplosion,
 canvas, angle, tower, ground, cannon, boat;
var balls = [];
var boats = [];
...
function showBoats() {
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      ...
      if (collision.collided && !boats[i].isBroken) { if(!isLaughing && !pirateLaughSound.isPlaying()){
        piratelaugh.play(); isLaughing = true } isGameOver = true; gameOver();} 
        }
    }
 else {
